...
If you have found what you think is a bug, please [file an issue](https://github.com/alvarlagerlof/react-haze/issues/new).
...
`react-haze` is using [Angular Commit Message Conventions](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines).
